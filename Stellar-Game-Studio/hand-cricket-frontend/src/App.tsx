...
const GAME_ID = 'hand-cricket';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Hand Cricket';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_HAND_CRICKET_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
